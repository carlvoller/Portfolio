    ...
    useEffect(() => {
        ...
        let onScroll = (e: any) => {
            ...
            if (window.scrollY >= window.innerHeight) {
                ...
                document.getElementById("horizontalScrollingContainer")!.style.left = `calc(0% - ${window.scrollY - window.innerHeight}px)`;
                //window.scrollTo(0, window.innerHeight);
                return false
            } else {
                document.getElementById("horizontalScrollingContainer")!.style.left = `0%`;
            }
        }
